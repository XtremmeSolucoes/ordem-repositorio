...
<head>
  ...
  <!--Espaço reservado para renderizar os estilos de cada view que estende esse layout-->
  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
        ...
        <li class="<?php echo (url_is('ordens*') ? 'active' : '') ?>"><a href="<?php echo site_url('ordens'); ?>"> <i class="icon-list"></i>Ordem de Serviços </a></li>
