    ...
    <div class="col-lg-8">
        ...
        <div class="user-block block">
            ...
            <?php if (empty($gruposDisponiveis)) : ?>
                ...
                <p class="contributions mt-0">Esse usuário já possui todos os grupos de acesso Disponiveis!</p>

                <?php else: ?>

                <p class="contributions text-white mt-0">Esse usuário já é Administrador, tem controle total do sistema!</p>   
    ...
    <div class="col-lg-8">
        <div class="user-block block">
            ...
            <?php if (empty($usuario->grupos)) : ?>
                ...
                <p class="contributions text-warning  mt-0">Esse usuário ainda não possui grupos de acesso!</p>
